        ...
        {result && (
          <>
            <div className="flex gap-4 p-2">
              <div className="text-center bg-green-500 text-white p-2 rounded shadow">
                <strong>CALL VALUE</strong>
                <br />${result.call.price?.toPrecision(4)}
              </div>
              <div className="text-center bg-red-500 text-white p-2 rounded shadow">
                <strong>PUT VALUE</strong>
                <br />${result.put.price?.toPrecision(4)}
              </div>
            </div>

            <div className="flex gap-2 bg-muted p-2 rounded text-sm">
              <div>
